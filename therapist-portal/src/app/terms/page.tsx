      ...
      <div style={{ maxWidth: 740, margin: '0 auto', padding: '72px 40px 120px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 48 }}>
          ...
          <Section title="Subscriptions and payments">
            ...
            <Item label="Refunds">Because access starts the moment you purchase, we can&apos;t refund unused days. If a technical issue stopped you from accessing the app, email us at <a href="mailto:talktoode.dev@gmail.com" style={{ color: 'var(--gold)' }}>talktoode.dev@gmail.com</a> within 7 days.</Item>
          ...
          <Section title="Contact">
            <P>Questions about these Terms: <a href="mailto:talktoode.dev@gmail.com" style={{ color: 'var(--gold)' }}>talktoode.dev@gmail.com</a></P>
          </Section>
