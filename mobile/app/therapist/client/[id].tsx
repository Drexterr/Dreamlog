...
const styles = StyleSheet.create({
  ...
  avatarText: { fontSize: 18, fontFamily: 'Nunito_700Bold' },
  title: { fontSize: 26, fontFamily: 'CormorantGaramond_500Medium' },
  meta: { fontSize: 12, fontFamily: 'Nunito_400Regular', marginTop: 2 },
  primaryBtn: {
    borderRadius: 14,
    paddingVertical: 15,
    alignItems: 'center',
  ...
  primaryBtnText: { color: '#fff', fontSize: 15, fontFamily: 'Nunito_600SemiBold' },
  ...
  emptyText: { fontSize: 13, fontFamily: 'Nunito_400Regular' },
  ...
  sessionDate: { fontSize: 14, fontFamily: 'Nunito_700Bold' },
  ...
  summaryBadge: { fontSize: 11.5, fontFamily: 'Nunito_600SemiBold', marginTop: 8 },
  deleteBtn: { alignItems: 'center', paddingVertical: 22 },
  deleteBtnText: { color: '#ef4444', fontSize: 13, fontFamily: 'Nunito_600SemiBold' },
});
