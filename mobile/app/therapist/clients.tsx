...
const styles = StyleSheet.create({
  ...
  privacyHint: { fontSize: 12, fontFamily: 'HankenGrotesk_400Regular', lineHeight: 17, marginBottom: 16 },
  sectionTitle: { fontSize: 19, fontFamily: 'Erode_500Medium', marginBottom: 10 },
  emptyCard: { borderRadius: 16, borderWidth: 1, padding: 18 },
  emptyText: { fontSize: 13, fontFamily: 'HankenGrotesk_400Regular', lineHeight: 20 },
  clientCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 12,
  ...
  avatarText: { fontSize: 14, fontFamily: 'HankenGrotesk_700Bold' },
  clientName: { fontSize: 15, fontFamily: 'HankenGrotesk_600SemiBold' },
  clientMeta: { fontSize: 12, fontFamily: 'HankenGrotesk_400Regular', marginTop: 2 },
  chevron: { fontSize: 24, lineHeight: 24 },
  linkedBadge: { borderWidth: 1, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 4 },
  linkedBadgeText: { fontSize: 10, fontFamily: 'HankenGrotesk_600SemiBold' },
  ...
  modalTitle: { fontSize: 20, fontFamily: 'Erode_500Medium', marginBottom: 14 },
  input: {
    borderRadius: 12,
    borderWidth: 1,
    padding: 14,
  ...
  errorText: { fontSize: 13, color: '#ef4444', fontFamily: 'HankenGrotesk_400Regular', marginBottom: 8 },
  ...
  modalCancelText: { fontSize: 14, fontFamily: 'HankenGrotesk_600SemiBold' },
  modalSave: { borderRadius: 12, paddingVertical: 12, paddingHorizontal: 20 },
  modalSaveText: { color: '#fff', fontSize: 14, fontFamily: 'HankenGrotesk_600SemiBold' },
});
