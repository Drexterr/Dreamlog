...
const styles = StyleSheet.create({
  ...
  backBtnText: { fontSize: 14, fontFamily: 'HankenGrotesk_400Regular' },
  container: { padding: 24, paddingBottom: 48 },
  title: { fontSize: 28, fontFamily: 'Erode_600SemiBold', marginBottom: 6 },
  date: { fontSize: 14, fontFamily: 'HankenGrotesk_400Regular', marginBottom: 28 },
  statsRow: {
    flexDirection: 'row',
    borderWidth: 1,
    borderRadius: 12,
  ...
  statLabel: { fontSize: 12, fontFamily: 'HankenGrotesk_400Regular' },
  ...
  summaryLabel: { fontSize: 11, fontFamily: 'HankenGrotesk_700Bold', letterSpacing: 1 },
  summaryText: { fontSize: 16, fontFamily: 'HankenGrotesk_400Regular', lineHeight: 26 },
  shareBtn: { alignSelf: 'flex-start' },
  shareBtnText: { fontSize: 14, fontFamily: 'HankenGrotesk_600SemiBold' },
  disclaimer: { fontSize: 12, fontFamily: 'HankenGrotesk_400Regular', lineHeight: 18, textAlign: 'center', marginBottom: 32 },
  primaryBtn: { borderRadius: 12, paddingVertical: 16, alignItems: 'center', marginBottom: 12 },
  primaryBtnText: { color: '#fff', fontSize: 17, fontFamily: 'HankenGrotesk_700Bold' },
  secondaryBtn: { alignItems: 'center', paddingVertical: 12 },
  secondaryBtnText: { fontSize: 15, fontFamily: 'HankenGrotesk_400Regular' },
  errorText: { textAlign: 'center', marginTop: 100, fontSize: 16, fontFamily: 'HankenGrotesk_400Regular' },
});
